...
def plot_efficient_frontier_position(mu, cov, w_opt, rf):
    """
    ...
    for i in range(n_portfolios):
        ...
        results[2, i] = (port_ret - rf) / port_vol if port_vol > 0 else 0
    ...
    plt.title('Efficient Frontier with Optimal Portfolio', fontsize=14, fontweight='bold')
...
def main():
    ...
    try:
        ...
        plot_efficient_frontier_position(mu, cov, w, rf)
